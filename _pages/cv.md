...
* **Liangshun Wu**,  Jianbo Du, Junsuo Qu. RIS-Aided Terahertz VR Streaming in Mobile Edge Computing via Improved DDPG with Action-Aware OU Noise Injection[J]_IEEE Transactions on Mobile Computing_,  2025. （IEEE TMC：智能反射面辅助太赫兹VR传输移动边缘计算；CCF A类，中科院1区，IF：9.2） 
...
* **Liangshun Wu**,  Junsuo Qu*,  Shilin Li,  Cong Zhang,  Jianbo Du,  Xiang Sun,  Jiehan Zhou. Attention-Augmented MADDPG in NOMA-Based Vehicular Mobile Edge Computational Offloading [J]. _IEEE Internet of Things Journal_,  2024. （IEEE IoTJ：非正交多址接入车联网移动边缘计算；中科院1区，IF：8.2）
